...
| 03 | Matrizes: lista de listas, acesso por linha e coluna, criar, alterar, percorrer com dois `for`, somar linhas e colunas, tabuleiro; ao final, a armadilha da multiplicação e a transposta | [`matrizes.py`](aula-03/matrizes.py) | [`Matrizes.java`](aula-03/Matrizes.java) | [`matrizes.js`](aula-03/matrizes.js) |
