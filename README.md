...
| 02 | Listas: criar, acessar, fatiar, alterar, adicionar, remover, procurar, ordenar e percorrer; ao final, cópia, comprehension e matrizes | [`listas.py`](aula-02/listas.py) | em breve | em breve |
